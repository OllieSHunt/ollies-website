...
Like the first version of this project, this keyboard uses a semi-split design and supports n-key rollover. Unlike the first design however, this keyboard has an RGB LED under every key and uses a small OLED display to show a variety of info. In addition, this board has a QWERTY, Dvorak, and stenography mode.

For a full list of features as well as a keymap cheatsheet, see the [GitHub repository for this project](https://github.com/OllieSHunt/custom-keyboard-v2).
...
For a full list of hardware (and bill of materials), see the [hardware repository](https://github.com/OllieSHunt/custom-keyboard-v2).  
...
The source code for this is located in [my fork of QMK](https://github.com/OllieSHunt/qmk_firmware). Within my fork, the firmware can be found in `dev_branch`, **not** the default `master` branch and will be under the folder `keyboards/custom_keyboard_v2`.
